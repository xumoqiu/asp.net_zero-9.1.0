...
using DynasysSolution.MultiTenancy.HostDashboard;
...
namespace DynasysSolution.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(DynasysSolutionDbContext context, SubscriptionPayment subscriptionPayment)
        {
