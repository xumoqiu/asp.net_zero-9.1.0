...
using DynasysSolution.Web.Public.Startup;
using DynasysSolution.Web.Session;

namespace DynasysSolution.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : DynasysSolutionViewComponent
    {
