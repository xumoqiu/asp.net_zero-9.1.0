...
using DynasysSolution.Web.Startup.ExternalLoginInfoProviders;
...
namespace DynasysSolution.Web.Startup
{
    ...
    public class DynasysSolutionWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public DynasysSolutionWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(DynasysSolutionWebHostModule).GetAssembly());
        }
