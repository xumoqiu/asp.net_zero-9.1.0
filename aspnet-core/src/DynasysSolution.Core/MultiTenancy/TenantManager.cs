...
using DynasysSolution.MultiTenancy.Demo;
...
namespace DynasysSolution.MultiTenancy
{
    ...
    public class TenantManager : AbpTenantManager<Tenant, User>
    {
            ...
            string emailActivationLink)
        {
            ...
            {
                throw new UserFriendlyException(LocalizationManager.GetString(DynasysSolutionConsts.LocalizationSourceName, "TrialWithoutEndDateErrorMessage"));
            }
        ...
        public async Task CheckEditionAsync(int? editionId, bool isInTrialPeriod)
        {
            ...
            var error = LocalizationManager.GetSource(DynasysSolutionConsts.LocalizationSourceName).GetString("FreeEditionsCannotHaveTrialVersions");
