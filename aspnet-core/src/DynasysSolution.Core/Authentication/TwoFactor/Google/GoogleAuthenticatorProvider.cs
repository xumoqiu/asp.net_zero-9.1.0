...
namespace DynasysSolution.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : DynasysSolutionServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("DynasysSolution", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
