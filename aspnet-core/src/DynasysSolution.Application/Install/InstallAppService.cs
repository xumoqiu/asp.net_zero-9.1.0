...
using DynasysSolution.Migrations.Seed.Host;
...
namespace DynasysSolution.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : DynasysSolutionAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<DynasysSolutionDbContext> _migrator;
        ...
        {
            var connectionString = _appConfiguration[$"ConnectionStrings:{DynasysSolutionConsts.ConnectionStringName}"];
        ...
        {
            EditAppSettingsjson($"ConnectionStrings:{DynasysSolutionConsts.ConnectionStringName}", constring);
        }
