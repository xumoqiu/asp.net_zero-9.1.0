...
using DynasysSolution.DashboardCustomization.Dto;
using Newtonsoft.Json;

namespace DynasysSolution.DashboardCustomization
{
    [AbpAuthorize]
    public class DashboardCustomizationAppService : DynasysSolutionAppServiceBase, IDashboardCustomizationAppService
    {
