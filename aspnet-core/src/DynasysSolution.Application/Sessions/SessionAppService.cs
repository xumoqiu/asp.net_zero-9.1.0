...
{
    public class SessionAppService : DynasysSolutionAppServiceBase, ISessionAppService
    {
        ...
        public async Task<GetCurrentLoginInformationsOutput> GetCurrentLoginInformations()
        {
            var output = new GetCurrentLoginInformationsOutput
            {
                Application = new ApplicationInfoDto
                {
                    ...
                    Currency = DynasysSolutionConsts.Currency,
                    CurrencySign = DynasysSolutionConsts.CurrencySign,
                    AllowTenantsToChangeEmailSettings = DynasysSolutionConsts.AllowTenantsToChangeEmailSettings,
