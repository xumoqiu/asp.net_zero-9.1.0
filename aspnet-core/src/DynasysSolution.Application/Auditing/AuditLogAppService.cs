...
using DynasysSolution.Auditing.Exporting;
...
using EntityHistoryHelper = DynasysSolution.EntityHistory.EntityHistoryHelper;

namespace DynasysSolution.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : DynasysSolutionAppServiceBase, IAuditLogAppService
    {
