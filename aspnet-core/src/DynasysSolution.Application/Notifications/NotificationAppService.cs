...
using Abp.UI;
using DynasysSolution.Notifications.Dto;

namespace DynasysSolution.Notifications
{
    [AbpAuthorize]
    public class NotificationAppService : DynasysSolutionAppServiceBase, INotificationAppService
    {
