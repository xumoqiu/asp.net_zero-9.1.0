...
using DynasysSolution.Friendships.Dto;

namespace DynasysSolution.Friendships
{
    [AbpAuthorize]
    public class FriendshipAppService : DynasysSolutionAppServiceBase, IFriendshipAppService
    {
