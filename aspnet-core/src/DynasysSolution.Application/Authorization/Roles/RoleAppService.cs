...
using DynasysSolution.Authorization.Permissions;
using DynasysSolution.Authorization.Permissions.Dto;
using DynasysSolution.Authorization.Roles.Dto;

namespace DynasysSolution.Authorization.Roles
{
    /// <summary>
    /// Application service that is used by 'role management' page.
    /// </summary>
    [AbpAuthorize(AppPermissions.Pages_Administration_Roles)]
    public class RoleAppService : DynasysSolutionAppServiceBase, IRoleAppService
    {
