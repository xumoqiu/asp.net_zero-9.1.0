...
using DynasysSolution.Authorization.Users.Delegation.Dto;

namespace DynasysSolution.Authorization.Users.Delegation
{
    [AbpAuthorize]
    public class UserDelegationAppService : DynasysSolutionAppServiceBase, IUserDelegationAppService
    {
