...
using DynasysSolution.Authorization.Users.Profile.Cache;
using DynasysSolution.Authorization.Users.Profile.Dto;
using DynasysSolution.Configuration;
using DynasysSolution.Friendships;
using DynasysSolution.Gdpr;
using DynasysSolution.Net.Sms;
using DynasysSolution.Security;
using DynasysSolution.Storage;
using DynasysSolution.Timing;

namespace DynasysSolution.Authorization.Users.Profile
{
    [AbpAuthorize]
    public class ProfileAppService : DynasysSolutionAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("DynasysSolution",
