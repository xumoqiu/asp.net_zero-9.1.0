...
namespace DynasysSolution.Core.Base
{
    public abstract class DynasysSolutionQueryBase<TField,TResult> : ITransientDependency
    {
        ...
        protected DynasysSolutionQueryBase(string fieldName,
