...
using DynasysSolution.Core.Base;
using DynasysSolution.Core.Extensions;
using DynasysSolution.Dto;
using DynasysSolution.Types;

namespace DynasysSolution.Queries
{
    public class OrganizationUnitQuery : DynasysSolutionQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
