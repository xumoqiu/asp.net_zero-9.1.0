...
using DynasysSolution.Services.Navigation;
...
using DynasysSolution.Controls;
using DynasysSolution.Dto;
using DynasysSolution.Extensions;
using DynasysSolution.Localization;
using DynasysSolution.UI;
using DynasysSolution.UI.Assets;
using DynasysSolution.Views;
using DependencyResolver = DynasysSolution.Core.Dependency.DependencyResolver;
...
namespace DynasysSolution.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "DynasysSolution";
