...
using DynasysSolution.EntityFrameworkCore.Repositories;

namespace DynasysSolution.MultiTenancy.Payments
{
    public class SubscriptionPaymentExtensionDataRepository : DynasysSolutionRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<DynasysSolutionDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
