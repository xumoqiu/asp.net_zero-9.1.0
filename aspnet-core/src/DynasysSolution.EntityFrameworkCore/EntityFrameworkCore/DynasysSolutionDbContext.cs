...
using DynasysSolution.MultiTenancy.Accounting;
using DynasysSolution.MultiTenancy.Payments;
using DynasysSolution.Storage;

namespace DynasysSolution.EntityFrameworkCore
{
    public class DynasysSolutionDbContext : AbpZeroDbContext<Tenant, Role, User, DynasysSolutionDbContext>, IAbpPersistedGrantDbContext
    {
        ...
        public DynasysSolutionDbContext(DbContextOptions<DynasysSolutionDbContext> options)
            : base(options)
        {
