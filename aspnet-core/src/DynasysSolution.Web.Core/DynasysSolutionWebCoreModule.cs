...
using DynasysSolution.Web.Authentication.JwtBearer;
using DynasysSolution.Web.Authentication.TwoFactor;
using DynasysSolution.Web.Chat.SignalR;
using DynasysSolution.Web.Configuration;
using DynasysSolution.Web.DashboardCustomization;

namespace DynasysSolution.Web
{
    [DependsOn(
        typeof(DynasysSolutionApplicationModule),
        typeof(DynasysSolutionEntityFrameworkCoreModule),
    ...
    public class DynasysSolutionWebCoreModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public DynasysSolutionWebCoreModule(IWebHostEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(DynasysSolutionApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(DynasysSolutionWebCoreModule).GetAssembly());
        }
        ...
        public override void PostInitialize()
        {
            ...
            IocManager.Resolve<ApplicationPartManager>()
                .AddApplicationPartsIfNotAddedBefore(typeof(DynasysSolutionWebCoreModule).Assembly);
        }
