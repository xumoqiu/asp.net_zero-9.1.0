...
import { DynasysSolutionCommonModule } from '@shared/common/common.module';
...
function initializeLocalForage() {
    localForage.config({
        ...
        name: 'DynasysSolution',
        version: 1.0,
        storeName: 'abpzerotemplate_local_storage',
        description: 'Cached data for DynasysSolution'
    });
}
...
@NgModule({
    imports: [
        ...
        AppModule,
        DynasysSolutionCommonModule.forRoot(),
        ServiceProxyModule,
        HttpClientModule,
        RootRoutingModule,
        NgxSpinnerModule
